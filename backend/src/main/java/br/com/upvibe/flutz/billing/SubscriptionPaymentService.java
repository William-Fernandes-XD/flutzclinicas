...
public class SubscriptionPaymentService {
    ...
    public PaymentResult pagarPix() {
        ...
        MercadoPagoService.Pagador pagador = pagadorAtual();
    ...
    private MercadoPagoService.Pagador pagadorAtual() {
        AuthPrincipal auth = AuthHolder.current();
        return jdbc.query(
                """
                SELECT nome_colaborador, email, cpf
    ...
    private static String mensagemCartao(Payment payment) {
        if (payment.getStatusDetail() == null || payment.getStatusDetail().isBlank()) {
