...
export const RACA_PRESETS_POR_ESPECIE: Record<string, string[]> = {
  ...
  rato: ["SRD", "Dumbo", "Hairless"],
  camundongo: ["SRD", "Fancy"],
  cavalo: ["Quarto de Milha", "Mangalarga", "Crioulo", "SRD"],
  porco: ["Mini pig", "SRD"],
  vaca: ["SRD", "Nelore", "Holandesa", "Jersey"],
  cabra: ["SRD", "Saanen", "Boer"],
  ovelha: ["SRD", "Dorper", "Santa Inês"],
  cobra: ["Corn Snake", "Píton", "Jiboia"],
  lagarto: ["Iguana", "Gecko", "Dragão-barbudo"],
  sapo: ["SRD", "Sapo-cururu"],
  inseto: ["Tarântula", "Louva-a-deus"],
  molusco: ["Caracol", "Lesma"],
  furão: ["Doméstico"],
  ouriço: ["SRD", "Africano pigmeu"],
  minhoca: ["SRD"],
  ovo: ["SRD"],
  outro: ["SRD"],
};
