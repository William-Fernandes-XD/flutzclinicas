...
export function HeroSection() {
  ...
  return (
    <section className="relative overflow-x-clip" aria-labelledby="hero-titulo">
      ...
      <PageContainer className="grid grid-cols-1 items-center gap-8 py-10 sm:gap-10 sm:py-14 xl:grid-cols-2 xl:py-16">
        ...
        >
          <p className="mb-4 text-sm font-semibold tracking-wide text-brand uppercase">
            Software SaaS para clínicas veterinárias
          </p>
          <h1
            id="hero-titulo"
            className="text-[1.65rem] font-bold tracking-tight break-words text-ink sm:text-3xl xl:text-4xl dark:text-white"
          >
            Flutz: SaaS de gestão para clínicas veterinárias
          </h1>
          <p className="mt-5 max-w-xl text-base leading-relaxed text-muted sm:text-lg dark:text-zinc-400">
            O Flutz é a plataforma na nuvem que centraliza a gestão da clínica — tutores, pets,
            agenda, atendimentos, vacinação e página pública — e conecta tutores às clínicas
            próximas, sem instalação.
          </p>
